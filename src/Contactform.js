...
//3. Setting Submit State for the Form, Setting Submit link to the Hyperlink
    const handleSubmit = (e) => {
        ...
        const url = `https://trainer.ntuclearninghub.com/QR/attendance?id=${name1}&date=${date}&start_time=${Date.parse(`${date} ${sTime} GMT+8`)}&end_time=${Date.parse(`${date} ${eTime} GMT+8`)}`;
        console.log(url);
